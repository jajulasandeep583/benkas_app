...
# License: GPL-3.0
"""
Ethanol Industries plant PWA — seed the Benkas PWA Config with the
user's SCADA Web Pages so the app home grid is webpages-only.

Run with:
    bench --site ethanol execute benkas.setup.ethanol_modules.setup
...
EXTRA_TILES = [
    {
        ...
        "badge_count_method": "benkas.api.approvals.pending_count",
