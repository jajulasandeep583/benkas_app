...
inside the Benkas PWA (it is rendered in a full-screen iframe by
...
<div class="mt-page">
  ...
  <div class="mt-body">
    Benkas crafts software that feels native and looks beautiful — from
