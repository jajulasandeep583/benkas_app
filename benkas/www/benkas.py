...
def _build_version():
    ...
    try:
        path = frappe.get_app_path("benkas", "public", "frontend", "index.js")
...
def get_context(context):
    """
    This file sits at benkas/www/benkas.py
    Frappe automatically maps it to the URL: yoursite.com/benkas
