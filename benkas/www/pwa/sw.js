/* Copyright (c) 2024, Benkas — GPL-3.0
...
var SHELL = [
  "/pwa",
  "/pwa/manifest.json",
  "/assets/benkas/js/pwa_app.js",
  "/assets/benkas/images/icon-192.png",
  "/assets/benkas/images/icon-512.png"
];
...
self.addEventListener("fetch", function (e) {
  ...
  var swr = url.pathname === "/pwa" ||
    ...
    url.pathname.indexOf("/assets/benkas") === 0 ||
    url.pathname.indexOf("/api/method/benkas") === 0;
  if (!swr) return;
