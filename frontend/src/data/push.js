...
const SW_URL = "/assets/benkas/frontend/push-sw.js";
...
export async function enablePush() {
  ...
  const keyRes = await apiFetch("/api/method/benkas.api.push.get_vapid_public_key");
  ...
  const save = await apiFetch("/api/method/benkas.api.push.subscribe", {
    method: "POST",
...
export async function disablePush() {
  ...
  if (sub) {
    ...
    await apiFetch("/api/method/benkas.api.push.unsubscribe", {
      method: "POST",
