...
// www/benkas.html references /assets/benkas/frontend/index.js
const PROD_BASE = "/assets/benkas/frontend/";
...
export default defineConfig(({ mode }) => ({
  ...
  // (its registration scope never matched /benkas anyway). Freshness
  // strategy instead: www/benkas.html cache-busts index.js with
  ...
  // ── Production build ───────────────────────────────────────────────────────
  // Output to ../benkas/public/frontend/
  // Frappe will then serve it at /assets/benkas/frontend/
  base: mode === "production" ? PROD_BASE : "/",
  build: {
    outDir:     "../benkas/public/frontend",
    emptyOutDir: true,
    sourcemap:   false,
    rollupOptions: {
      output: {
        // www/benkas.html references these by exact name
